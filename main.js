...
function LoadFile(event, file) {
	...
	var extToMimetypes = {'json':'application/json','jpg':'image/jpeg','png':'image/png','wav':'audio/wav','webm':'video/webm','mp3':'audio/mp3','mp4':'video/mp4','txt':'text/plain','pdf':'application/pdf','doc':'application/vnd.ms-word;charset=utf-8'};
	...
	mainWindow.webContents.once('did-finish-load', function() {
		...
		ipc.on('choose-files-dialog', function(event) {
			var dialogSettings = {
				...
				filters: [
					{name: 'Activities', extensions: ['jpg','png','json','webm','wav','mp3','mp4','pdf','txt','doc']}
				]
			};
