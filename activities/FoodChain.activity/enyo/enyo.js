...
n = r + n;
if (n.slice(-4) != ".css" && n.slice(-5) != ".less") return n.slice(-3) == ".js" && n.slice(-10) != "package.js" ? (this.verbose && console.log("+ module: [" + r + "][" + e + "]"), this.requireScript(e, n, t)) : (this.requirePackage(n, t), !0);
this.verbose && console.log("+ stylesheet: [" + r + "][" + e + "]"), this.requireStylesheet(n);
},
