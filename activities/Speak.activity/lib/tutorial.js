	...
	tutorial.start = function() {
		var steps = [
			...
			},
			{
				...
				title: "gamemode1",
				content: l10n.get(TutoABC)
			},
			{
				element: "#gamemode2-button",
				title: "gamemode2",
				content: l10n.get(TutoInteract)
            },
            {
				element: "#gamemode3-button",
				title: "gamemode3",
				content: l10n.get(TutoVoiceChat)
            },
            {
				element: "#language-button",
				title: "language",
				content: l10n.get(TutoLanguage)
            },
            {
				element: "#speech-button",
				title: "speech",
				content: l10n.get(TutoSpeech)
            },
            {
				element: "#face-button",
				title: "face",
				content: l10n.get(TutoFace)
			}
		];
		var tour = new Tour({
            template: "\
