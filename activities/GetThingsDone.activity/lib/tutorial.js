    ...
    tutorial.start = function () {
        var steps = [
            ...
            },
            {
                element: "#new-todo",
                placement: "bottom",
                title: l10n.get("TutoCreateTodoTitle"),
                content: l10n.get("TutoCreateTodoContent")
            },
            {
                element: "#new-todo-button",
                placement: "bottom",
                title: l10n.get("TutoAddTodoTitle"),
                content: l10n.get("TutoAddTodoContent")
            },
            {
                element: "#stop-button",
                placement: "bottom",
