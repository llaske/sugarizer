...
function p4_move(state, s, e, promotion){
    ...
    */
    ...
    // console.log(state);
    cap(state);
    // getdetails(flags,movestring,state);
    this.movesofplay++;
    return {
        flags: flags,
        string: movestring,
...
function p4_move_copy(state, s, e, promotion){
    var board = state.board;
    console.log("cicked");
    var colour = state.to_play;
    var other_colour = 1 - colour;
...
function getdetails(fl,st,stateis){
    console.log("fl:");
    console.log(fl);
    console.log("st");
    console.log(st);
...
function cap(a){
    ...
    console.log("keys");
    // console.log(keys[len-2]);
    var sendingfen = keys[len-1];
    fenarray.push(sendingfen);
    sendtoactivity(sendingfen);
    objs.push(a);
...
function retu_cap(){
    console.log(objs);
    console.log("moves:");
    console.log(this.movesofplay);
    return objs;
}
function sendtoactivity(fenstring){
    var strring = fenstring;
    return strring;
}
function returnfenarray(){
    return fenarray;
}
...
function p4_fen2state(fen, state){
    ...
    console.log("fen2state1");
    console.log(state);
    var board = state.board;
    var fenbits = fen.split(' ');
    var fen_board = fenbits[0];
    console.log("fen_bloar");
    console.log("fe"+fen_board);
    var fen_toplay = fenbits[1];
    console.log(fen_toplay);
    ...
    state.move_copy = function(s, e, promotion){
        return p4_move_copy(this, s, e, promotion);
    };
...
function p4_fen2state_copy(fen, state){
    if (state === undefined)
        state = p4_initialise_state();
    console.log("fen2state1");
    console.log(state);
