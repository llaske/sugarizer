	...
	tutorial.start = function() {
		var steps = [
				...
				},
				{
					...
					title: l10n.get("TutoCalculatorTitle"),
					content: l10n.get("TutoCalculatorContent")
				},
				{
					element: "#results-zone",
					title: l10n.get("TutoResultsTitle"),
					content: l10n.get("TutoResultsContent")
				},
				{
				...
				},
				{
					...
					placement: "bottom",
					title: l10n.get("TutoOutputDigitsTitle"),
					content: l10n.get("TutoOutputDigitsContent")
				}
			];
		var tour = new Tour({
			template: "\
