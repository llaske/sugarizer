...
const app = new Vue({
	...
	mounted() {
		this.newSugarL10n = this.$refs.newSugarL10n;
	...
	methods: {
		...
		localized() {
			this.newSugarL10n.localize(this.l10n);
		...
		onJournalNewInstance() {
			...
			this.pref.labels.x = this.newSugarL10n.get("Sports"); 
			this.pref.labels.y = this.newSugarL10n.get("Students");
		...
		exportAsImage() {
			...
			this.createJournalEntry(imgData, metadata, this.newSugarL10n.get("exportImage"));
		},
		exportAsCsv() {
			const header = [this.pref.labels.x, this.pref.labels.y];
			...
			this.createJournalEntry(csvContent, metadata, this.newSugarL10n.get("exportedLogAsCSV"));
		},
