    ...
    zoompalette.ZoomPalette = function (invoker, primaryText) {
        ...
        `
            <div style="margin: 10px;">
                ...
                <input id="zoomSlider" class="multiplatformInputSlider" type="range" min="0" max="95" step="0.00001" value="0.0005" oninput="app.ZoomInOut()" style="vertical-align: top;margin-top: 10%;">
