...
define(["settings"], function(preferences) {
	...
	server.getJournal = function(journalId, typeactivity, stime, favorite, field, response, error) {
		var url = server.getServerUrl() + constant.sendCloudURL + journalId + "?limit="+constant.syncJournalLimit+"&sort=-timestamp";
		var params = {};
