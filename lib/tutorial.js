	...
	tutorial.init = function() {
		...
		if (currentView == constant.radialView) {
			tutorial.addSteps([
				...
				{
					element: tutorial.getElement("showAssignments"),
					position: "bottom",
					title: l10n.get("TutoShowAssignmentTitle"),
					intro: insertIcon('./icons/assignment.svg')+l10n.get("TutoShowAssignmentContent"),
			...
			tutorial.addSteps([
				...
				{
					element: tutorial.getElement("submit"),
					position: "bottom",
					title: l10n.get("TutoAssignmentSubmitTitle"),
					intro: l10n.get("TutoAssignmentSubmitContent")
				},
				{
					element: tutorial.getElement("instructions"),
					position: "bottom",
					title: l10n.get("TutoAssignmentInstructionTitle"),
					intro: l10n.get("TutoAssignmentInstructionContent")
				},
				{
					element: tutorial.getElement("assignment"),
					position: "bottom",
					title: l10n.get("TutoAssignmentButtonTitle"),
					intro: l10n.get("TutoAssignmentButtonContent")
				},
				{
				...
				{
					element: tutorial.getElement("assignmentbutton"),
					position: "top",
					title: l10n.get("TutoAssignmentFilterButtonTitle"),
					intro: l10n.get("TutoAssignmentFilterButtonContent")
				},
				{
		...
		} else if(currentView == constant.assignmentView) {
			tutorial.addSteps([
				{
					title: l10n.get("TutoAssignmentIntroTitle"),
					intro: l10n.get("TutoAssignmentIntroContent")
				},
				{
					element: tutorial.getElement("activityitem"),
					position: "bottom",
