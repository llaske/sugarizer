...
define(["webL10n","sugar-web/datastore","FileSaver"], function (l10n, datastore, FileSaver) {
	...
	util.writeFile = function(directory, metadata, content, callback) {
		...
		if (util.getClientType() == constant.appType && (enyo.platform.android || enyo.platform.androidChrome || enyo.platform.ios || enyo.platform.electron)) {
	...
	util.loadFile = function(file, callback) {
		...
		if (util.getClientType() == constant.webAppType || (util.getClientType() == constant.appType && !enyo.platform.android && !enyo.platform.androidChrome && !enyo.platform.ios && !enyo.platform.electron)) {
			...
			var validTypes = ['application/json','image/jpeg','image/png','audio/wav','video/webm'];
	...
	util.computeDatastoreSize = function(callback) {
		...
		var total = (enyo.platform.safari || enyo.platform.ios) ? 5224448 : 10446848; // 5Mb for Safari/iOS, 10Mb for other browsers
		var used = 0;
