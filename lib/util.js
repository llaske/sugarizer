...
define(["webL10n"], function (l10n) {
	...
	util.timestampToElapsedString = function(timestamp, maxlevel) {
	 ...
	 util.clickToTap = function(sender, event) {
		// HACK: On IE, onclick = ontap
		if (enyo.platform.ie || (!enyo.platform.safari && !enyo.platform.firefox && !enyo.platform.chrome)) {
console.log("ClickToTap");
			sender.bubble("ontap", sender, event);
		}
	 }
