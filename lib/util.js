...
define(["webL10n"], function (l10n) {
	...
	util.computeMargin = function(size, maxpercent) {
		...
		return { left: parseFloat(canvas_width-size_width)/2.0, top: parseFloat(canvas_height-size_height)/2.0 };
	}
	...
	util.vibrate = function() {
		if ((enyo.platform.androidChrome || enyo.platform.ios) && navigator.vibrate) {
